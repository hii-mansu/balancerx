    ...
    <header className="sticky top-0 z-50 bg-slate-950/80 backdrop-blur-md border-b border-slate-800">
      ...
      {open && (
        <div className="md:hidden bg-slate-900 border-b border-slate-800 px-4 pt-2 pb-6 space-y-3">
          <a href="#features" onClick={() => setOpen(false)} className="block py-2 text-slate-300 hover:text-cyan-400">Features</a>
          <a href="#architecture" onClick={() => setOpen(false)} className="block py-2 text-slate-300 hover:text-cyan-400">Architecture</a>
          <a href="#docs" onClick={() => setOpen(false)} className="block py-2 text-slate-300 hover:text-cyan-400">Documentation</a>
          <a href="#creator" onClick={() => setOpen(false)} className="block py-2 text-slate-300 hover:text-cyan-400">Creator</a>
          <a
            href="https://github.com/hii-mansu/balancerx"
            target="_blank"
            rel="noreferrer"
